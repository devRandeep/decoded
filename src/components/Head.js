            ...
            <Col md={10}>
              <BrowserRouter>
                <ul className="appMenuList">
                  <li>
                    <NavLink exact activeClassName="menuActive" to="/about">
                      About Us
                    </NavLink>
                  </li>
                  <li>
                      ...
                      <div className="subMenuMainWrap">
                        ...
                        <div className="columnData">
                          <div className="menuTitle pinkLine">
                            <strong>
                              Academies / Apprenticeships (Mastery)
                            </strong>
                          </div>
                          <ul>
                            <li>
                  ...
                  <li>
                    <NavLink exact activeClassName="menuActive" to="/insights">
                      Insights
                    </NavLink>
                  </li>
                  <li>
                    <NavLink exact activeClassName="menuActive" to="/careers">
                      Careers
                    </NavLink>
                  </li>
                  <li>
